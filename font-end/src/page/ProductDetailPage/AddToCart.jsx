            ...
            <div id='order_block'>
                <div id='order_block-buy'>
                    ...
                    <div id='order_addQuantity'>
                        ...
                        >
                            <FiMinus
                                className='order_addQuantity-text order_addQuantity-text1'
                            />
                        </div>
                        <input
                            type='number'
                        ...
                        >
                            <FiPlus
                                className='order_addQuantity-text order_addQuantity-text2'
                            />
                        </div>
                    </div>
                </div>
                <div id='order_addToCart' onClick={onAddToCart}>
                    <div className='addToCart'>
                        <IoCartOutline className='addToCart-icon'/>
                        <p className='addToCart-text'>
                            Thêm vào giỏ hàng
                        </p>
                    </div>
                </div>
