                ...
                <div id='blk_footer1'>
                    ...
                    <div id='blk_footer-text'>
                        <p className='text-address text'>
                            <b>Địa chỉ:</b> Số 90, Đường GS1, P.Đông Hòa, Tp.HCM
                        </p>
                        <p className='text-nameStore text'>
                            <b>Top Sport</b> - Cửa hàng đồ thể thao uy tín, chất lượng hàng đầu Việt Nam
                        </p>
                        <p className='text-introduce text'>
                            Top Sport nhận đặt hàng trực tuyến và giao hàng tận nơi.
                            KHÔNG hỗ trợ đặt mua và nhận hàng trực tiếp tại văn phòng cũng như tất cả các Chi nhánh của Shop trên toàn quốc.
                        </p>
                    </div>
                    <div id='blk_img-MIT'>
                    ...
                    <div id='footer2'>
                        ...
                        <div id='blk_contact'>
                            <div className='contact-address contact'>
                                ...
                                <p className='text_small-contact'>Số 90, Đường GS1, P.Đông Hòa, Tp.HCM</p>
                            </div>
